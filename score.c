...
/**
* @brief initialiser le scoreboard
* @param co the coin
* @return Nothing
*/
...
/**
* @brief initialiser coin pour stage 1-1 .
* @param s star
* @return Nothing
*/
...
/**
* @brief initialiser coin pour stage 1-2
* @param s star
* @return Nothing
*/
...
/**
* @brief initialiser coin 2 stage 1-1.
* @param s star
* @return Nothing
*/
...
/**
* @brief initialiser coin2 pour stage 1-2
* @param s star
* @return Nothing
*/
...
/**
* @brief initialiser coin3 pour stage 1-1
* @param s star
* @return Nothing
*/
...
/**
* @brief initialiser coin3 pour stage 1-2
* @param s star
* @return Nothing
*/
...
/**
* @brief chnager postion coin pour stage 1-2
* @param s star
* @return Nothing
*/
...
/**
* @brief changer position coin pour stage 1-22
* @param s star
* @return Nothing
*/
...
/**
* @brief affichez star 
* @param s star screen sdl surface
* @return Nothing
*/
...
/**
* @brief affichez scoreboard
* @param coin co,int score nb , screen sdl surface
* @return Nothing
*/
